...
- Both product goals are answered as of 2026-09-11: ambient dims under cover, and a camera-to-light sphere trace through the engine's signed distance field separates a lamp behind a wall from the same lamp in the open. Section 4b of the forensics document is the consolidated handover, including the thin-margin limit and the stopping rule that keeps t224, the engine raymarch and DXR closed. The occlusion gate and the perceptual ambient curve belong to `C:\DEV\CrimsonHue`, not here.
