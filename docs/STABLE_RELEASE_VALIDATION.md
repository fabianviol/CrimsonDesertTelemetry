...
load. The owner then reproduced compilation with the mod disabled, exited during
the compile, activated the mod and restarted directly into the game without a new
compile. Telemetry did not initiate compilation in this observed A/B sequence.
The second modded start did not reproduce the capture failure. Final2.1.10 waits for the host's
