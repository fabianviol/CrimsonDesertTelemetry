...
{
#if defined(CDT_FIRE_VISIBILITY)
    // Exact Variant A parameters from the previously live-tested rendered-fire
    // path. Keep this production fallback stable while broader visibility remains
