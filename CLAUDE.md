...
- PARKED after a 2026-09-11 game update. All Ambient, Variant A and HUD evidence/packages target the previous supported build; do not install or extrapolate them to the updated game. Resume only on explicit request by identifying the new build/hash and running existing fail-closed preflight checks. Keep t224, engine-raymarch reconstruction, DXR and new PIX work closed. CrimsonHue remains untouched.
